...
(* OASIS_START *)
(* DO NOT EDIT (digest: c7ec3428d6585d2d0f5b2fb8e9e8dd96) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("safepass-api", OCamlbuildDocPlugin.doc_build "src")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("safepass-api", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\172\205\174\240jG\245*\172\128\131r \237 \127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
