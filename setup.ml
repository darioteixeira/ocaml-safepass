...
(* OASIS_START *)
(* DO NOT EDIT (digest: bf5600d0a88726a83c2f2a82cdad3b08) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ocaml-safepass-api", OCamlbuildDocPlugin.doc_build "./")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ocaml-safepass-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = None;
          synopsis = "OCaml bindings to Openwall's Bcrypt.";
          description = None;
          categories = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Ocaml-safepass";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest =
       Some "e\0126\246\162\150$\163\141\165\205\234|\026\222\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
